...
- Runs contrary to [Keep It Simple Stupid (KISS) principle](http://principles-wiki.net/principles:keep_it_simple_stupid), but both call for simplicity:
  ...
  - [EUHM](http://principles-wiki.net/principles:easy_to_use_and_hard_to_misuse) calls for simplified use, and complicated / impossible misuse. Accepts increased complexity in the implementation.
